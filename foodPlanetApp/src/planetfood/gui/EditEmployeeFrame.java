...
public class EditEmployeeFrame extends javax.swing.JFrame {
    ...
    private boolean validateData() {
        if (txtEmpName.getText().isEmpty() | txtSalary.getText().isEmpty() | txtEmpId.getText().isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("D:\\planet food icons\\content-150x150.png")); // NOI18N
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (e != null) {
            ...
            jcbJob.setSelectedItem(e.getEmpJob());
