...
public class ProductsDao {
    ...
    public static HashMap<String, String> getAllProductsIdByCategory(String catId) throws SQLException {
     ...
     public static HashMap<String, String> getAllProduct() throws SQLException {
        PreparedStatement prmt = DBConnection.getConnection().prepareStatement("select prod_id, prod_name from products");
        ResultSet rs = prmt.executeQuery();
        HashMap<String, String> al = new HashMap<String, String>();
        while (rs.next()) {
            al.put(rs.getString("prod_id"), rs.getString("prod_name"));
        }
        return al;
    }
