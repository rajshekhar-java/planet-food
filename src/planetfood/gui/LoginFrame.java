...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private boolean validateInput() {
        ...
        char pas[] = txtPassword.getPassword();
        if (userId.isEmpty() || pas.length == 0) {
            return false;
        } else {
    ...
    private void initComponents() {
        ...
        jrbCashier.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\Rajshekhar sahu\\Pictures\\Screenshots\\Screenshot (39).png")); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (validateInput()) {
            ...
            up.setUserType(getUserType());
            try {
                String userName = UsersDao.validateUser(up);
                if (userName != null) {
                ...
                JOptionPane.showMessageDialog(null, "Unable to fatch data", "Error", JOptionPane.ERROR_MESSAGE);
                ex.printStackTrace();
            }
        } else {
            JOptionPane.showMessageDialog(null, "Enter complete information", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_btnLoginActionPerformed

    private void btnQuitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuitActionPerformed
        // TODO add your handling code here:
        int ans = JOptionPane.showConfirmDialog(null, "Are you sure ?", "Quitting", JOptionPane.YES_NO_OPTION);
